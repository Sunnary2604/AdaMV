...
import pandas as pd
import math
df = pd.read_csv("F:/GitHub/LayoutCMV_Code-Paper/show-system/demo1/country-original-covid-data.csv")
number=[0,0,0,0,0,0]
land=["Asia","America","Europe","Africa","Oceania","SA"]
for i in range(df.shape[0]):
    ...
    if(df.iloc[i]["land"]=="SA"):
        number[5]=number[5]+df.iloc[i]["total cases"]
