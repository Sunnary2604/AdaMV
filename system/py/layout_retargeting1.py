...
def layout(outputDevices, inputJson, weight):
    ...
    [root, inputViewNodes,pageLimitation] = spilt_NTree(inputJson, inputDevice)
    ...
    [permutationRes, outputDevicesPRes] = global_permutation(root, outputDevices,pageLimitation)
